...
`)
let rocket_3 = sprites.create(img`
        . . . . . . . . . . . . . . 8 8 
            . . . . . . . . . . . . . 8 8 8 
            . . . . . . . . . . . . 8 8 6 6 
            . . . . . . . . . . . . 8 6 6 9 
...
for (let index = 0; index < 4; index++) {
    rocket_3.setVelocity(100, -10)
    rocket_3.x = scene.screenWidth()
    rocket_3.vx = -100
    rocket_3.y = randint(10, scene.screenHeight() - -10)
}
for (let index2 = 0; index2 < 4; index2++) {
    _1.setVelocity(100, -10)
    _1.x = scene.screenWidth()
    _1.vx = -100
    _1.y = randint(10, scene.screenHeight() - -15)
}
for (let index3 = 0; index3 < 4; index3++) {
    _2.setVelocity(100, -10)
    _2.x = scene.screenWidth()
    _2.vx = -120
    _2.y = randint(10, scene.screenHeight() - -20)
}
for (let index4 = 0; index4 < 4; index4++) {
    _3.setVelocity(100, -10)
    _3.x = scene.screenWidth()
    _3.vx = -80
    _3.y = randint(10, scene.screenHeight() - 5)
}
